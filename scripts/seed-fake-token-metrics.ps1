...
# Keep fake traffic scoped to existing APIM subscriptions.
$subscriptionUsers = @(
    @{ SubscriptionId = 'user01-subscription'; UserId = 'user01' },
    @{ SubscriptionId = 'user02-subscription'; UserId = 'user02' },
    @{ SubscriptionId = 'user03-subscription'; UserId = 'user03' },
    @{ SubscriptionId = 'user04-subscription'; UserId = 'user04' },
    @{ SubscriptionId = 'user05-subscription'; UserId = 'user05' }
)
